! function i(s, a, n) {
    ...
    1: [function(e, t, r) {
        "use strict";
        var i = e("@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/impression"),
            s = e("@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/slim/api"),
            c = e("@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/utils"),
            a = e("@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/queryString"),
            d = e("@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/components/reviewDisclaimer"),
            v = e("@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/slim/templates/stars"),
            p = e("@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/slim/templates/logo"),
            m = e("@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/dom"),
            n = e("@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/slim/init");
        (0, i.attachImpressionHandler)();

        function o(e) {
            var t, r, i, s, a, n, o, l = e.baseData,
                u = e.locale;
            s = document.getElementById("tp-widget-wrapper"), (0, m.removeClass)(s, "tp-widget-wrapper--placeholder"), (0, c.setHtmlLanguage)(u), !l.translations || (a = l.translations).trustpilotCustomWidget && (document.getElementById("tp-widget-title").innerHTML = a.trustpilotCustomWidget), t = (n = {
                baseData: l,
                locale: u
            }).locale, r = n.baseData, i = r.businessEntity, e = i.numberOfReviews.total, s = i.trustScore, a = r.translations, n = document.getElementById("translations-reviews"), i = document.getElementById(e ? "businessEntity-numberOfReviews-total" : "reviews-summary"), r = document.getElementById("trust-score"), t = e ? (0, c.insertNumberSeparator)(e, t) : a.noReviews, (0, c.setHtmlContent)(i, t), (0, c.setTextContent)(r, s.toFixed(1)), (0, c.setTextContent)(n, a.reviews), (0, v.populateStars)(l, "tp-widget-stars", null, u), (0, p.populateLogo)(), a = (n = {
                baseData: l
            }).baseData, u = a.businessEntity.numberOfReviews.total, n = a.links, a = document.getElementById("profile-link"), n = u ? n.profileUrl : n.evaluateUrl, a.href = g(n), a = {
                "[trustScoreRating]": (u = l).starsString,
                "[trustScore]": u.businessUnit.trustScore,
                "[totalScore]": 5,
                "[reviewCount]": u.businessEntity.numberOfReviews.total
            }, n = (0, c.makeTranslatedLinkAccessibleNames)("widgetLabel", "businessRatingTextWithReviewCount", "clickProfileLink", f, a), u = n.ariaLabel, a = n.ariaDescription, n = n.ariaInstruction, document.getElementById("profile-link").setAttribute("aria-label", u), document.getElementById("screen-reader-only-rating").textContent = a, document.getElementById("screen-reader-only-instruction").textContent = n, l.settings.customStylesAllowed && (h && (0, c.setFont)(h), w && (0, c.setTextColor)(w)), b && (o = document.getElementById("tp-widget-review-disclaimer")) && new d.ReviewDisclaimer(o, f).render()
        }
        var g = (0, c.addUtmParams)("Mini"),
            l = (0, a.getAsObject)(),
            f = l.locale,
            e = l.businessunitId,
            i = l.theme,
        ...
        (0, n.init)(function() {
            return (0, s.fetchServiceReviewData)(u)(y, o)
        })
    }, {
        "@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/components/reviewDisclaimer": 34,
        "@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/dom": 35,
        "@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/impression": 37,
        "@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/queryString": 39,
        "@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/slim/api": 42,
        "@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/slim/init": 47,
        "@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/slim/templates/logo": 50,
        "@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/slim/templates/stars": 51,
        "@trustpilot/trustbox-framework-vanilla/lib_legacy/modules/utils": 57
    }],
    35: [function(e, t, r) {
        "use strict";
        ...
        r.addClass = (e, t) => {
            if (e) {
                ...
                var r = i ? i.split(" ") : [];
                s(e, t) || (t = [...r, t].join(" "), e.setAttribute("class", t))
            }
        };
        r.removeClass = (e, t) => {
            if (e) {
                const r = e.className.split(" ");
                e.className = r.filter(e => e !== t).join(" ")
            }
        };
        r.populateElements = e => {
            e.forEach(({
                element: e,
                string: t,
                substitutions: r = {}
            }) => {
                t ? (0, i.setHtmlContent)(e, (0, i.makeTranslations)(r, t), !1) : (0, i.removeElement)(e)
            })
        }
    }, {
        "./utils": 57
    ...
    37: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.attachImpressionHandler = void 0;
        const u = e("./queryString"),
            c = e("./rootUri"),
            i = e("./utils"),
            s = e("./xhr");
        ...
        function a(e, {
            ...
            s && i && function(e, t, r) {
                const i = "path=/",
                    s = `domain=${window.location.hostname.replace(/^.*\.([^.]+\.[^.]+)/,"$1")}`,
                    a = "samesite=none",
                    n = "secure";
                document.cookie = [`${e}=${t}`, i, r, s, a, n].join("; "), document.cookie = [`${e}-legacy=${t}`, i, r, s].join("; ")
            }(`TrustboxSplitTest_${a}`, encodeURIComponent(JSON.stringify({
                group: s,
                session: t,
                testId: r
            })), i)
        ...
        function n(e, t) {
            ...
            t = function(e, t) {
                ...
                return t = Object.keys(l).map(e => `${e}=${encodeURIComponent(l[e])}`).join("&"), `${(0,c.getWidgetRootUri)()}/stats/${e}?${t}`
            }(e, t);
            try {
                (0, s.xhr)({
                    url: t
        ...
        let o;
        r.attachImpressionHandler = function() {
            (0, i.addEventListener)(window, "message", function(t) {
                if ("string" == typeof t.data) {
                    ...
                    if ("setId" === e.data.command) return o = e.data.widgetId, void window.parent.postMessage(JSON.stringify({
                        command: "impression",
                        widgetId: o
                    }), "*");
                    "impression-received" === e.data.command && (delete e.data.command, n("TrustboxImpression", e.data)), "trustbox-in-viewport" === e.data.command && (delete e.data.command, n("TrustboxView", e.data))
                }
            })
        }
    }, {
    ...
    39: [function(e, t, r) {
        ...
        function s(e) {
            const t = ["?", "#"];
            const r = (0, i.compose)(i.pairsToObject, e => e.split("&").filter(Boolean).map(e => {
                var [t, e] = e.split("=");
                try {
            ...
            }).filter(Boolean), e => -1 !== t.indexOf(e[0]) ? e.substring(1) : e);
            return r(e)
        }
    ...
    47: [function(e, t, r) {
        ...
        const i = e("../communication"),
            s = e("./templates/errorFallback");
        r.init = e => {
            let t = !1;
            (0, i.onPong)(() => {
    ...
    57: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.showTrustBox = r.setTextColor = r.setFont = r.setHtmlLanguage = r.sanitizeHtmlProp = r.sanitizeColor = r.addUtmParams = void 0, r.addEventListener = i, r.getOnPageReady = function() {
        ...
        }, r.makeTranslatedLinkAccessibleNames = function(e, t, r, i, s) {
            if (!e || !t || !r) return "";
            e = (0, n.getFrameworkTranslation)(e, i, {}), s = (0, n.getFrameworkTranslation)(t, i, s), i = (0, n.getFrameworkTranslation)(r, i, {});
            return {
                ariaLabel: e,
                ariaDescription: s,
                ariaInstruction: i
            ...
            return e ? Object.keys(r).reduce((e, t) => e.split(t).join(r[t]), e) : (void 0, "")
        }, r.removeElement = function(e) {
            if (e && e.parentNode) return e.parentNode.removeChild(e)
        }, r.setHtmlContent = function(e, t, r = !0) {
            e && (e.innerHTML = r ? o(t) : t)
        ...
        r.sanitizeHtmlProp = e => e = "string" == typeof e ? (e = (e = e.replaceAll(">", "")).replaceAll("<", "")).replaceAll('"', "") : e;
        const o = e => "string" != typeof e ? e : e.replace(/(<\/?(?:p|b|i|li|ul|a|strong)\/?>)|(?:<\/?.*?\/?>)/gi, "$1");
        o;
        r.showTrustBox = (e, t) => {
            var r = document.getElementsByTagName("body")[0],
                i = document.getElementById("tp-widget-wrapper");
            (0, s.addClass)(r, e), (0, s.addClass)(i, "visible"), t || (0, s.addClass)(r, "first-reviewer")
        };
        const l = t => e => `${(e=>`${e}${-1===e.indexOf("?")?"?":"&"}`)(e)}utm_medium=trustbox&utm_source=${t}`;
        r.addUtmParams = l;
        const u = (e, t = 1) => {
    ...
    `)), document.head.appendChild(t)
        ...
        r.setFont = e => {
            var t = (0, a.getWidgetRootUri)(),
                r = e.replace(/\s/g, "-").toLowerCase();
            const i = document.createElement("link");
            i.rel = "stylesheet", i.href = `${t}/fonts/${r}.css`, document.head.appendChild(i);
            e = e.replace(/\+/g, " ");
    ...
    * {
    ...
    `)), document.head.appendChild(s)
        ...
        "./dom": 35,
        "./models/styleAlignmentPositions": 38,
        "./rootUri": 40,
        "./translations": 56
    }],
    50: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.populateLogo = void 0;
        const i = e("../../dom"),
            s = e("../assets/logo"),
            a = e("../templating"),
            n = () => (0, a.mkElemWithSvg)(s.logo);
        n;
        r.populateLogo = (e = "tp-widget-logo") => {
    ...
    34: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.ReviewDisclaimer = void 0;
        const i = e("../support"),
            s = e("../templating"),
            a = e("../translations");
        r.ReviewDisclaimer = class {
            constructor(e, t = "en-US", r = "") {
                if (!e) throw new Error("Root element is required for ReviewDisclaimer");
                this.root = e, this.locale = t, this.className = r
            }
            get reviewDisclaimerText() {
                var e = (0, a.formatLocale)(this.locale);
                return (0, a.getFrameworkTranslation)("reviewDisclaimer.body", e)
            }
            get reviewDisclaimerLink() {
                var e = (0, a.formatLocale)(this.locale);
                return (0, i.getReviewDisclaimerLink)(e)
            }
            get reviewDisclaimerDescription() {
                var e = (0, a.formatLocale)(this.locale);
                return (0, a.getFrameworkTranslation)("reviewDisclaimer.description", e)
            }
            render() {
                var e = "tp-widget-review-disclaimer__description",
                    t = (0, s.a)({
                        href: this.reviewDisclaimerLink,
                        target: "_blank",
                        rel: "noopener noreferrer nofollow",
                        class: this.className ? `tp-widget-review-disclaimer__link ${this.className}` : "tp-widget-review-disclaimer__link",
                ...
                this.root.classList.add("active"), this.root.innerHTML = `${t} ${e}`, this.mounted = !0
            }
        }
    }, {
        "../support": 54,
    ...
    51: [function(e, t, r) {
        ...
        const o = e("../../dom"),
            ...
            v = ({
                ...
                var n = Math.floor(e),
                    o = e === n ? "" : ` tp-stars--${n}--half`,
                    i = (0, l.sanitizeColor)(i);
                return (0, c.div)({
                    class: r
                }, (0, c.mkElemWithSvg)(u.stars, `${i?"tp-stars-custom-color":`tp-stars tp-stars--${n}${o}`}`, {
                    rating: e,
                    trustScore: t || e,
                    color: i,
                    locale: s,
        ...
        r.populateStars = ({
            ...
            translations: i
        }, s = "tp-widget-stars", a, n = d.defaultLocale) => {
            a = (0, l.sanitizeColor)(a), s = "string" == typeof s ? document.getElementById(s) : s, e = r ? e : 0;
    ...
    42: [function(e, t, r) {
        ...
        const s = e("./fetchData");
        Object.defineProperty(r, "constructTrustBoxAndComplete", {
            enumerable: !0,
            get: function() {
                return s.constructTrustBoxAndComplete
            }
        });
        const i = e("./productReviews");
        Object.defineProperty(r, "fetchProductData", {
            enumerable: !0,
            get: function() {
                return i.fetchProductData
            }
        }), Object.defineProperty(r, "fetchProductReview", {
            enumerable: !0,
            get: function() {
                return i.fetchProductReview
            }
        });
        r.fetchServiceReviewData = i => (e, t, r) => {
            (0, s.fetchData)(`/trustbox-data/${i}`)(e, t, r, s.hasServiceReviews)
        }
    }, {
        "./fetchData": 41,
        "./productReviews": 43
    ...
    16: [function(e, t, r) {
        "use strict";
        var s, a = this && this.__createBinding || (Object.create ? function(e, t, r, i) {
                void 0 === i && (i = r);
            ...
            i = this && this.__importStar || (s = function(e) {
                return (s = Object.getOwnPropertyNames || function(e) {
                    var t, r = [];
                    for (t in e) Object.prototype.hasOwnProperty.call(e, t) && (r[r.length] = t);
                    return r
                })(e)
            }, function(e) {
                ...
                var t = {};
                if (null != e)
                    for (var r = s(e), i = 0; i < r.length; i++) "default" !== r[i] && a(t, e, r[i]);
                return n(t, e), t
            });
        Object.defineProperty(r, "__esModule", {
            value: !0
        });
        var o = i(e("./da-DK/strings.json")),
            l = i(e("./de-AT/strings.json")),
            u = i(e("./de-CH/strings.json")),
            c = i(e("./de-DE/strings.json")),
            d = i(e("./en-AU/strings.json")),
            v = i(e("./en-CA/strings.json")),
            p = i(e("./en-GB/strings.json")),
            m = i(e("./en-IE/strings.json")),
            g = i(e("./en-NZ/strings.json")),
            f = i(e("./en-US/strings.json")),
            h = i(e("./es-ES/strings.json")),
            w = i(e("./fi-FI/strings.json")),
            b = i(e("./fr-BE/strings.json")),
            y = i(e("./fr-FR/strings.json")),
            L = i(e("./it-IT/strings.json")),
            N = i(e("./ja-JP/strings.json")),
            R = i(e("./nb-NO/strings.json")),
            S = i(e("./nl-BE/strings.json")),
            j = i(e("./nl-NL/strings.json")),
            I = i(e("./pl-PL/strings.json")),
            E = i(e("./pt-BR/strings.json")),
            T = i(e("./pt-PT/strings.json")),
            k = i(e("./ru-RU/strings.json")),
            D = i(e("./sv-SE/strings.json")),
            e = i(e("./zh-CN/strings.json"));
        r.default = {
            "da-DK": o,
            "de-AT": l,
            "de-CH": u,
    ...
    28: [function(e, t, r) {
        ...
        const o = e("../queryString"),
            l = e("../rootUri"),
            u = e("../xhr");
        r.apiCall = (a, n) => new Promise((e, t) => {
            let r, i;
            var s;
            if (0 === a.indexOf("/") && (r = n || {}, {
                    token: s
                } = (0, o.getAsObject)(), s && (r.random = (t => {
                    let r = "";
                    var i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
                    for (let e = 0; e < t; e++) r += i.charAt(Math.floor(Math.random() * i.length));
                    return r
                })(20))), 0 === a.indexOf("http")) i = a.replace(/^https?:/, "https:");
            else {
                if (0 !== a.indexOf("/")) return t();
                i = (0, l.getWidgetRootUri)() + a
            }
            return (0, u.xhr)({
                url: i,
                data: r,
    ...
    58: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            ...
            "GET" === t.type && t.data && (t.url = `${t.url}?${function(e){const t=[];for(const r in e)e.hasOwnProperty(r)&&t.push(`${encodeURIComponent(r)}=${encodeURIComponent(e[r])}`);return t.join("&")}(t.data)}`, delete t.data);
            (i() && i() <= 9 ? function(e) {
                const t = new window.XDomainRequest,
                    r = window.location.protocol;
                e.url = e.url.replace(/https?:/, r), t.open(e.type, e.url), t.onload = function() {
                    e.success(s(t))
                }, t.onerror = function() {
                    e.error(s(t))
                }, setTimeout(function() {
                ...
                const t = window.XMLHttpRequest || ActiveXObject,
                    r = new t("MSXML2.XMLHTTP.3.0");
                r.open(e.type, e.url, !0), r.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), r.onreadystatechange = function() {
                    4 === r.readyState && (200 <= r.status && r.status < 300 ? e.success(s(r)) : e.error(s(r)))
                }, r.send(e.data)
            })(t)
        }
    }, {}],
    29: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.ReviewFetcher = void 0;
        const a = e("../../fn"),
            i = e("../call"),
            s = e("./responseProcessor"),
            n = e("./util"),
            o = "No reviews available";
        r.ReviewFetcher = class {
            constructor({
                reviewsPerPage: e,
                includeImportedReviews: t,
                baseData: r,
                ...i
            }) {
                const s = (0, n.getNextPageLinks)(e => (0, a.pipeMaybe)((0, a.prop)(e), (0, a.prop)("links"), (0, a.prop)("nextPage")));
                this.reviewsPerPage = e, this.includeImportedReviews = t, this.baseData = r, this.nextPage = s(r, t), this.wrapArgs = i, this.reviews = this._makeResponseProcessor(r).getReviews()
            }
            consumeReviews(t) {
                return () => this.produceReviews().then(e => t({ ...this.wrapArgs,
                    baseData: this.baseData,
                    reviews: e,
                    hasMoreReviews: this.hasMoreReviews,
                    loadMoreReviews: this.consumeReviews.bind(this)
                })).catch(e => {
                    if (e === o) return t({ ...this.wrapArgs,
                        baseData: this.baseData,
                        reviews: [],
                        hasMoreReviews: !1,
                        loadMoreReviews: this.consumeReviews.bind(this)
            ...
            produceReviews() {
                return 0 === this.reviews.length ? Promise.reject(o) : this.reviewsPerPage >= this.reviews.length ? this._fetchReviews().then(e => {
                    const t = this._makeResponseProcessor(e);
                    return this.nextPage = t.getNextPageLinks(), this.reviews.push(...t.getReviews()), this._takeReviews()
            ...
            _fetchReviews() {
                return (0, a.promiseAllObject)((0, a.mapObject)(i.apiCall, this.nextPage))
            }
            _makeResponseProcessor(e) {
                return new s.ReviewResponseProcessor(e, {
    ...
    36: [function(e, t, r) {
        ...
        const i = t => e => e.filter(t);
        i;
        r.map = t => e => e.map(t);
        r.mapObject = (r, i) => Object.keys(i).reduce((e, t) => ({ ...e,
            [t]: r(i[t])
        }), {});
        r.promiseAllObject = t => {
            const i = Object.keys(t);
            var e = i.map(e => t[e]);
            return Promise.all(e).then(e => e.reduce((e, t, r) => ({ ...e,
                [i[r]]: t
            }), {}))
        };
        r.pairsToObject = e => e.reduce((e, [t, r]) => ({ ...e,
            [t]: r
        }), {});
        const s = e => null == e;
        r.rejectNullaryValues = r => Object.keys(r).reduce((e, t) => ({ ...e,
            ...s(r[t]) ? {} : {
                [t]: r[t]
            }
        }), {});
        r.compose = (...t) => e => t.reduceRight((e, t) => t(e), e);
        const a = (...t) => e => t.reduce((e, t) => s(e) ? e : t(e), e);
        r.pipeMaybe = a;
        const n = ([e]) => e;
        n;
        r.find = e => a(i(e), n);
        r.prop = t => (e = {}) => e[t];
        r.propMaybe = t => (e = {}) => e[t] || e;
        r.guard = t => e => (e => s(e) || !1 === e)(t) ? null : e
    }, {}],
    31: [function(e, t, r) {
        "use strict";
        Object.defineProperty(r, "__esModule", {
        ...
        const s = e("../../fn");
        r.getNextPageLinks = i => (e, t = !1) => {
            var r = i("productReviews")(e),
                e = (0, s.pipeMaybe)((0, s.guard)(t), i("importedProductReviews"))(e);
            return (0, s.rejectNullaryValues)({
                productReviews: r,
    ...
    30: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.ReviewResponseProcessor = void 0;
        const i = e("../../fn"),
            s = e("./util");
        r.ReviewResponseProcessor = class {
            constructor(e, {
                includeImportedReviews: t,
                displayName: r
            }) {
                this.response = e, this.includeImportedReviews = t, this.displayName = r
            }
            getReviews() {
                var {
                    productReviews: e,
                    importedProductReviews: t
                } = this.response, e = (0, i.pipeMaybe)((0, i.propMaybe)("productReviews"), (0, i.propMaybe)("reviews"))(e) || [], t = (0, i.pipeMaybe)((0, i.guard)(this.includeImportedReviews), (0, i.propMaybe)("importedProductReviews"), (0, i.propMaybe)("productReviews"), (0, i.map)(e => ({ ...e,
                    verifiedBy: "External" === e.type && e.source ? e.source.name : this.displayName
                })))(t) || [];
                return [...e, ...t].sort(({
                    createdAt: e
                }, {
                    createdAt: t
                }) => new Date(t) - new Date(e))
            }
            getNextPageLinks() {
                const e = (0, s.getNextPageLinks)(e => (0, i.pipeMaybe)((0, i.prop)(e), (0, i.prop)("links"), (0, i.find)(e => "next-page" === e.rel), (0, i.prop)("href"))),
                    t = (0, s.getNextPageLinks)(e => (0, i.pipeMaybe)((0, i.prop)(e), (0, i.prop)(e), (0, i.prop)("links"), (0, i.prop)("nextPage")));
                var r = t(this.response, this.includeImportedReviews);
                return { ...e(this.response, this.includeImportedReviews),
                    ...r
                }
            }
        }
    ...
    32: [function(e, t, r) {
        ...
        const n = e("../translations"),
            s = e("../utils"),
            o = 'style="position: absolute; height: 100%; width: 100%; left: 0; top: 0;"',
            i = (e, t, r = {}) => {
                var i = Object.keys(r).reduce((e, t) => (e[t] = (0, s.sanitizeHtmlProp)(r[t]), "color" === t && (e[t] = (0, s.sanitizeColor)(e[t])), e), {});
                return `
  ...
  <svg role="img" aria-labelledby="scaleRating" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 ${e.width} ${e.height}">
      <g class="tp-stars">
        ${((e,a)=>l[e].lines.reduce((e,{x1:t,y1:r,x2:i,y2:s})=>`
        $ {
            e
        } < line x1 = "${t}"
        y1 = "${r}"
        ...
        `})(t,i,r)}
            ...
            trustScore: r,
            color: i,
            locale: s = n.defaultLocale
        }) => {
            var a = `starRating-${Math.random().toString(36).substring(2)}`,
                r = {
                    "[ratingStars]": r,
                    "[totalStars]": 5
                },
                r = (0, n.getFrameworkTranslation)("starRating", s, r),
                s = (0, n.formatLocale)(s);
            return `
...
`, b = {
        ...
        r.svgMap = {
            scale: e => i(l[e.dimensionId].dimensions, a, e),
            stars: e => i(b, c, e),
            logo: () => i(y, d),
            arrowSlider: () => i(L, v),
            arrowSliderCircle: () => i(N, p),
            replyArrow: e => i(R, m, e),
            verifiedReview: e => i(S, g, e),
            verifiedReviewFlex: e => i(S, f, e),
            invitedReview: e => i(j, h, e),
            redirectedReview: e => i(I, w, e)
        }
    }, {
        "../translations": 56,
        "../utils": 57
        ...
        const n = {
            ...
            o = e => {
                ...
                var t = e.split("-"),
                    e = t[0];
                let r = t[1];
                return r = r || (t = e, n[t] || t), e && r ? `${e}-${r.toUpperCase()}` : a
            };
        r.formatLocale = o;
        const l = (e, t) => e.reduce((e, t) => e[t], t);
        r.getFrameworkTranslation = (e, t = a, r = {}, i = []) => {
            t = ((e, t) => {
                e = e.split(".");
                return l(e, t) || l(e, s.default[a])
            })(e, s.default[o(t)] || s.default[a]), t = Object.keys(r).reduce((e, t) => e.replace(t, r[t]), t);
            return i.reduce((e, t) => e.replace("[LINK-END]", "</a>").replace("[LINK-BEGIN]", t), t)
        }
    }, {
        "../localization": 16
    }],
    33: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.onPong = r.ping = void 0, r.setListener = c, r.isLoadedMessage = function(e) {
            return "loaded" === e
        ...
        function l(e) {
            n ? (e.widgetId = n, e = JSON.stringify(e), s.postMessage(e, "*")) : a.push(e)
        }
        ...
        r.onPong = t => {
            ...
            if ("string" == typeof e.data) {
                ...
                if ("setId" === t.data.command) n = t.data.widgetId,
                    function() {
    ...
    54: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.getReviewDisclaimerLink = r.normalizeSupportLocale = void 0;
        r.normalizeSupportLocale = e => {
            switch (e) {
                case "en-US":
                case "nl-NL":
                    return e.replace("-", "_");
        ...
        r.getReviewDisclaimerLink = e => {
            return `https://help.trustpilot.com/s/article/How-do-we-make-sure-reviews-are-trustworthy?language=${(0,r.normalizeSupportLocale)(e)}`
        }
    }, {}],
    55: [function(e, t, r) {
        "use strict";
        ...
        e("./assets/svg");
        const i = e("./utils"),
            s = t => Object.keys(t).map(e => {
                return `${e}="${(0,i.sanitizeHtmlProp)(t[e])}"`
            }).join(" "),
            a = (e, t, ...r) => `<${e} ${s(t)}>${[].concat(...r).join("\n")}</${e}>`;
        r.a = (e, ...t) => a("a", e, ...t);
        const n = (e, ...t) => a("div", e, ...t);
        n;
        r.span = (e, ...t) => a("span", e, ...t)
    }, {
        "./assets/svg": 32,
        "./utils": 57
    }],
    38: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.styleAlignmentPositions = void 0;
    ...
    41: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.hasProductReviews = r.hasServiceReviewsMultiFetch = r.hasServiceReviews = r.constructTrustBoxAndComplete = r.multiFetchData = r.fetchData = void 0;
        const u = e("../../api/call"),
            c = e("../../communication"),
            d = e("../../fn"),
            v = e("../../utils"),
            p = e("../templates/errorFallback"),
            m = e("../templates/loader"),
            g = "default_singleFetch_f98ac77b",
            i = ({
                businessEntity: {
                    numberOfReviews: {
                        total: e
        ...
        r.hasServiceReviews = i;
        r.hasServiceReviewsMultiFetch = t => {
            const e = Object.keys(t);
            return e.some(e => i(t[e]))
        };
        r.hasProductReviews = ({
            productReviewsSummary: e,
            importedProductReviewsSummary: t
        }) => {
            return 0 < (e ? e.numberOfReviews.total : 0) + (t ? t.numberOfReviews.total : 0)
        };
        const f = (n, o = !1, l = i) => ({
            baseData: t,
            locale: r,
            ...
            o && (0, c.setListener)(({
                ...
                (0, c.isLoadedMessage)(e) && (0, c.sendAPIDataMessage)({
                    baseData: t,
                    locale: r
                })
            }), (0, v.showTrustBox)(e, a), (0, p.removeErrorFallback)()
        };
        r.constructTrustBoxAndComplete = f;
        const a = l => (e, t, r, i) => {
            const {
                locale: s,
                theme: a = "light"
            } = e[Object.keys(e)[0]];
            var n, o = (0, d.promiseAllObject)((0, d.mapObject)((n = l, ({
                    businessUnitId: e,
                    locale: t,
                    ...r
                }) => {
                    r = (0, d.rejectNullaryValues)({
                        businessUnitId: e,
                        locale: t,
                        ...r,
                        theme: null
                    });
                    return (0, u.apiCall)(n, r)
                }), e)),
                e = (0, v.getOnPageReady)(),
                i = Promise.all([o, e]).then(([e]) => {
                    var t;
                    return {
                        baseData: (t = e, e = Object.keys(t), g in t && 1 === e.length ? t[g] : t),
                        locale: s,
                        theme: a
                    }
                }).then(f(t, r, i)).catch(e => {
                    if (e && e.FallbackLogo) return (0, p.errorFallback)()
                });
            (0, m.withLoader)(i)
        };
        r.multiFetchData = a;
        r.fetchData = s => (e, t, r, i) => {
            e = {
                default_singleFetch_f98ac77b: e
            };
            a(s)(e, t, r, i)
        }
    }, {
    ...
    48: [function(e, t, r) {
        ...
        const i = e("../../dom"),
            ...
            a = e("../assets/logo"),
            n = e("../templating");
        r.errorFallback = (e = "tp-widget-fallback") => {
            ...
            (0, i.populateElements)([{
                ...
                }, (0, n.mkElemWithSvg)(a.logo, "fallback-logo"))
            }])
        };
        r.removeErrorFallback = (e = "tp-widget-fallback") => {
            e = document.getElementById(e);
            (0, s.removeElement)(e)
        }
    }, {
    ...
    49: [function(e, t, r) {
        ...
        const s = e("../../dom"),
            ...
            o = e("../templating");
        r.withLoader = (e, {
            loaderElement: t = "tp-widget-loader",
            delay: r = 1e3
        } = {}) => {
            const i = setTimeout(() => (e => {
                ...
                (0, s.populateElements)([{
                    element: e,
                    string: (0, o.mkElemWithSvg)(n.logo)
                }])
            })(t), r);
            return e.finally(() => {
                clearTimeout(i), (e => {
                    ...
                    e = `${e}--loaded`;
                    (0, s.addClass)(t, e), t && (t.addEventListener("animationend", () => (0, a.removeElement)(t)), t.addEventListener("webkitAnimationEnd", () => (0, a.removeElement)(t)), t.addEventListener("oanimationend", () => (0, a.removeElement)(t)))
                })(t)
            })
        }
    }, {
    ...
    43: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.fetchProductReview = r.fetchProductData = void 0;
        const i = e("../../api/call"),
            o = e("../../api/reviewFetcher"),
            l = e("./fetchData");
        r.fetchProductData = r => (s, a, e = !1, n = !1) => {
            var t = 0 < s.reviewsPerPage ? ({
                baseData: e,
                locale: t,
                ...r
            }) => {
                const i = new o.ReviewFetcher({
                    baseData: e,
                    includeImportedReviews: n,
                    reviewsPerPage: parseInt(s.reviewsPerPage),
                    locale: t,
                    ...r
                });
                return i.consumeReviews(a)()
            } : a;
            (0, l.fetchData)(`/trustbox-data/${r}`)(s, t, e, l.hasProductReviews)
        };
        r.fetchProductReview = (e, t, r) => {
            (0, i.apiCall)(`/product-reviews/${e}`, {
                locale: t
            }).then(r)
        }
    }, {
        "../../api/call": 28,
        "../../api/reviewFetcher": 29,
        "./fetchData": 41
    }],
    44: [function(e, t, r) {
        "use strict";
    ...
    46: [function(e, t, r) {
        ...
        const o = e("../translations"),
            ...
            i = (e, {
                ...
                color: i,
                translations: s,
                locale: a = o.defaultLocale
            }) => {
                var n = `starRating-${Math.random().toString(36).substring(2)}`,
                    r = {
                        "[ratingStars]": r,
                        "[totalStars]": 5
                    },
                    r = (0, o.getFrameworkTranslation)("starRating", s, r),
                    a = (0, o.formatLocale)(a);
                return `
    <svg role="img" viewBox="0 0 ${e.width} ${e.height}" xmlns="http://www.w3.org/2000/svg" ${l.svgStarStyle}>
      <title id="${n}" lang=${a}>${r}</title>
      <g class="tp-star">
          <path class="tp-star__canvas" fill="${1<=t&&i?i:u}" d="M0 46.330002h46.375586V0H0z"/>
          <path class="tp-star__shape" d="M39.533936 19.711433L13.230239 38.80065l3.838216-11.797827L7.02115 19.711433h12.418975l3.837417-11.798624 3.837418 11.798624h12.418975zM23.2785 31.510075l7.183595-1.509576 2.862114 8.800152L23.2785 31.510075z" fill="#FFF"/>
      </g>
    ...
    53: [function(e, t, r) {
        ...
        r.formatLocale = e => {
            ...
            var t = e.split("-"),
                e = t[0];
            let r = t[1];
            return r = r || (t = e, s[t] || t), e && r ? `${e}-${r.toUpperCase()}` : i
        };
        r.getFrameworkTranslation = (e, t, r = {}, i = []) => {
            t = ((e, t) => {
                e = e.split(".");
                return t = t, e.reduce((e, t) => e && e[t] ? e[t] : "", t || {})
            })(e, t), t = Object.keys(r).reduce((e, t) => e.replace(t, r[t]), t);
            return i.reduce((e, t) => e.replace("[LINK-END]", "</a>").replace("[LINK-BEGIN]", t), t)
        }
    }, {}],
    52: [function(e, t, r) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.mkElemWithSvg = r.div = r.a = void 0;
        const i = e("../utils"),
            s = t => Object.keys(t).map(e => {
                return `${e}="${(0,i.sanitizeHtmlProp)(t[e])}"`
            }).join(" "),
