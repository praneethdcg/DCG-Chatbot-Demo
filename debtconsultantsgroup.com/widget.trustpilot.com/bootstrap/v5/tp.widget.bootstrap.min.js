! function n(o, s, r) {
    ...
    1: [function(e, t, i) {
        ...
        e = (i.WIDGET_ROOT = i.LAZY_LOADED_WIDGETS = i.EMPTY_WIDGET_ID = void 0, e("./iframeRootUtils").validateWidgetRoot)(window.__TP_WIDGET_ROOT_CONFIG__);
        i.EMPTY_WIDGET_ID = "000000000000000000000000", i.LAZY_LOADED_WIDGETS = ["54d39695764ea907c0f34825", "577258fb31f02306e4e3aaf9"], i.WIDGET_ROOT = e
    }, {
        "./iframeRootUtils": 2
    }],
    2: [function(e, t, i) {
        ...
        var n = "https://widget.trustpilot.com";
        i.validateWidgetRoot = function(t) {
            if (!t) return n;
            try {
                var e = new URL(t);
                return ["http:", "https:"].includes(e.protocol) ? "localhost" === (i = e.hostname) || i.match(/^localhost:\d+$/) || "127.0.0.1" === i || i.match(/^127\.0\.0\.1:\d+$/) || "[::1]" === i || i.match(/^\[::1\]:\d+$/) ? -1 !== n.indexOf("widget.trustpilot.com") ? (console.warn("Localhost not allowed in production"), n) : e.toString().replace(/\/$/, "") : n : (console.warn("Invalid protocol: " + e.protocol), n)
            } catch (e) {
                return console.warn("Invalid URL: " + t, e), n
            }
            var i
        }
    }, {}],
        ...
        (function(e, t, i) {
            ...
            value: function(d) {
                var e = !0,
                    ...
                    i = void 0;
                try {
                    for (var n, o = d[Symbol.iterator](); !(e = (n = o.next()).done); e = !0) {
                        var s = n.value;
                        if ("childList" === s.type) {
                            var r = !0,
                                a = !1,
                                l = void 0;
                            try {
                                for (var c, u = s.addedNodes[Symbol.iterator](); !(r = (c = u.next()).done); r = !0) 1 === c.value.nodeType && this.handleMutations()
                            } catch (e) {
                                a = !0, l = e
                            } finally {
                                try {
    ...
    4: [function(e, t, i) {
        ...
        function f(e) {
            try {
                ...
                t.setAttribute("type", "application/ld+json"), t.innerHTML = JSON.stringify(e), document.head.appendChild(document.createComment("Added by Trustpilot")), document.head.appendChild(t), document.head.appendChild(document.createComment("/Added by Trustpilot")), h = !0
            } catch (e) {}
        }
        var p = e("./constants.js").WIDGET_ROOT,
            m = e("./xhr.js");
        var y = {
        ...
        t.exports = function(e) {
            if (h) return !1;
            if (e.schemaType && e.location) return a = (r = e).businessunitId, l = r.location, u = r.locale, r = r.templateId, r = ["url=" + encodeURIComponent(window.location.href), "templateId=" + r, "locale=" + u].join("&"), m.xhrGet({
                url: p + ("/data/jsonld/business-unit/" + a + "/location/" + l) + "?" + r,
                success: function(e) {
            ...
            if (e.sku) {
                u = e.templateId === y.productReviewsCarousel;
                if ((e.templateId === y.productReviewsSEO || e.templateId === y.productReviewsMultiSourceSEO) && e.name || u && "Product" === e.schemaType) return l = (a = e).businessunitId, r = a.locale, e = a.templateId, t = a.name, d = a.sku, c = a.reviewnumber, i = a.price, n = a.priceCurrency, a = a.availability, r = r && r.split("-")[0], o = e === y.productReviewsMultiSourceSEO, o = p + (o ? "/data/jsonld/business-unit/" + l + "/product-imported" : "/data/jsonld/business-unit/" + l + "/product") + "?sku=" + encodeURIComponent(d) + "&numberOfReviews=" + (c || 10) + (t ? "&productName=" + encodeURIComponent(t) : "") + "&language=" + r + "&templateId=" + e + "&url=" + encodeURIComponent(window.location.origin + window.location.pathname), s = i && n && a ? {
                    "@type": "Offer",
                    priceCurrency: n,
                    price: i,
                    availability: a
                    ...
                    url: o,
                    success: function(e) {
                        s && (e.offers = s), (e.offers || e.review || e.aggregateRating) && f(e)
                    },
                    error: function(e) {
                        console.error(e)
                    }
    ...
    6: [function(e, d, t) {
        ...
        var s = e("../constants"),
            r = e("../../localization");
        var a = s.WIDGET_ROOT,
            c = s.WIDGET_ROOT + "/trustboxes",
            h = "53aa8912dec7e10d38f59f36,539adbd6dec7e10e686debee,539ad60defb9600b94d7df2c,539ad998dec7e10e686debe0,539ad0ffdec7e10e686debd7,54d0e1d8764ea9078c79e6ee,54ad5defc6454f065c28af8b".split(",");
        ...
        n(u, [{
            ...
            value: function() {
                var e = this.iframeData || {
                    ...
                    t = r.title[this.dataset.locale] || r.title[r.defaultLocale];
            ...
            value: function(e, t) {
                var i, n;
                this._iframe = (i = this.getIframeOptionsFromData(), (n = document.createElement("iframe")).style.position = i.position, n.style.zIndex = i.zindex, n.style.margin = i.margin, n.style.top = i.top, n.style.bottom = i.bottom, n.style.left = i.left, n.style.right = i.right, n.style.height = i.height, n.style.width = i.width, n.style.minHeight = i.minHeight, n.style.minWidth = i.minWidth, n.style.borderStyle = i.borderStyle, n.style.backgroundColor = i.backgroundColor, n.style.display = i.display, n.style.overflow = i.overflow, n.allowTransparency = i.allowTransparency, n.title = i.title, n.loading = i.loading || "auto", n.src = i.src, i.allow && (n.allow = i.allow), i.tabIndex && (n.tabIndex = i.tabIndex), n), e.appendChild(this._iframe), this._iframe.addEventListener("load", t)
            }
        }, {
            key: "sendMessage",
            value: function(e) {
                this._iframe.contentWindow && (e = JSON.stringify(e), this._iframe.contentWindow.postMessage(e, a))
            }
        }, {
            key: "isInViewport",
            value: function(e) {
            ...
            value: function() {
                var e = !0,
                    ...
                    i = void 0;
                try {
                    for (var n, o = this.OVERFLOW_PROPERTIES[Symbol.iterator](); !(e = (n = o.next()).done); e = !0) {
                        var s = n.value;
                        document.body.style.removeProperty(s), this.defaultOverflowProperties[s] && document.body.style.setProperty(s, this.defaultOverflowProperties[s])
                    }
                } catch (e) {
                    t = !0, i = e
                } finally {
            ...
            value: function() {
                return "true" === this.dataset.allowRobots && this.dataset.location && -1 < h.indexOf(this.templateId)
            }
        }, {
            key: "dimensions",
            get: function() {
                return {
                    height: l(this.dataset.styleHeight),
                    width: l(this.dataset.styleWidth)
                }
            }
        }, {
            key: "queryString",
    ...
    7: [function(e, r, t) {
        ...
        i(d, null, [{
            ...
            key: "initialize",
            value: function() {
                !this.isLazyLoaded || this.isContainerInViewport() ? (this._widgetIFrameOrigin = u.WIDGET_ROOT, this.createIFrame("main"), this.attachMessageListener()) : this.lazyLoadTimeout = setTimeout(this.initialize, 500)
            }
        }, {
            key: "handleCommand",
            value: function(e) {
            ...
            value: function(e, t) {
                ...
                this.iframes[e] = o, this.stats.createIFrameCalls += 1, o.initialize(n ? document.body : this.container, function() {
    ...
    8: [function(e, t, i) {
        ...
        function l(e, t, i) {
            var n = i.session,
                ...
                i = i.templateId;
            if (!(this instanceof l)) throw new TypeError("Cannot call a class as a function");
            this.hasSentImpression = !1, this.hasSentViewTracking = !1, this.sendMessage = e, this.isTrustBoxVisible = t, this.session = n, this.group = s, this.sessionExpiry = o, this.anonymousId = r, this.testId = a, this.templateId = i
        }
        i.default = e
    }, {
        "../constants": 1
    ...
    11: [function(e, t, i) {
        ...
        var n, o, s = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            ...
            r = "1.479.0";
        try {
            n = e("./lib/widget-management.js").default, o = window.Trustpilot && 0 < Object.keys(window.Trustpilot).length, window.Trustpilot = o ? window.Trustpilot : {
            ...
            try {
                "object" === (void 0 === e ? "undefined" : s(e)) ? a(e.message): a(e)
            } catch (e) {
